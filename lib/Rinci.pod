...
=head3 Property: default_locale => STR

Specify default locale used in the text properties like C<summary> and
C<description>. Default is 'en_US'.

To specify translation texts in other languages, you can use
C<PROPERTY.alt.locale.CODE>, e.g.:

 summary => "Perform the foo ritual",
 "summary.alt.locale.id_ID" => "Laksanakan ritual foo",
...
To specify translations in other language, use the L<summary.alt.locale.CODE>.
Or change the C<default_locale> property. Examples:

 # default locale is 'en_US'
 summary => 'Perform the foo ritual',
 "summary.alt.locale.id_ID" => 'Laksanakan ritual foo',

 # change default locale to id_ID, so all summaries are in Indonesian
 default_locale => 'id_ID',
 summary => 'Laksanakan ritual foo',
 "summary.alt.locale.en_US" => 'Perform the foo ritual',
...
L<description.alt.locale.CODE> property.
