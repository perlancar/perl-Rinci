...
specification keys: C<summary> (a string, optional), C<code> (a code to set
argument value, optional, will be given reference to arguments hash; if not set,
the default behavior is simply to set the argument value).
