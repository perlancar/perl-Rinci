...
=item * feature: tx => BOOL | HASH

Default is false. If set to true, specifies that function supports transactional
operation. Currently there is little further specification; transactional
feature is used alongside with undo protocol, described in
