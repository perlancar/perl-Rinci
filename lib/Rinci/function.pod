...
exists), B<require> (bool, defaults to false, whether function always require
...
Currently there is little further specification; transactional feature is used
alongside with undo protocol, described in L<Rinci::function::Undo>.
