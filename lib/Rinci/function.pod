...
checking for range 200-299). See also C<partial_result> feature.
...
=head1 feature: partial_result => bool
...
Function will send the range it actually sends via result metadata properties C<
