...
=head2 Undo and transaction

Transaction, as described in L<Rinci::function::Transaction>, uses undo as the
basis. It has a stricter requirement for the undo data, and a couple of other
extra requirements for the function to be able to participate in transaction.
For more details, refer to the Rinci::function::Transaction documentation.
...
Related specifications: L<Rinci::function::Transaction>

Implementations: L<Perinci::Sub::Gen::Undoable>
