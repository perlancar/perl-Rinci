...
passed C<-tx> special argument (the transaction context object, described in
...
also passes C<-tx>. Function gets the list of steps from the transaction context
object:

 my @steps = $tx->get_undo_steps;
