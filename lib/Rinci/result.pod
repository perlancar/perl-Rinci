...
=head2 Property: error_stack => ARRAY

When reporting error that results from a call to another function, the original
error response can be prepended to this stack, to preserve information. See
L<Perinci::Sub::Util>'s C<wrapres()> for a convenient function to build error
stack.
